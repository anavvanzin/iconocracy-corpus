...
Codifies the AGENTS.md retry policy: "If an API fails twice, switch to fallback
...
- **SCOUT** (the `scout`/`buscar` mode in AGENTS.md mode routing) calls this
...
- Keep retrying the same endpoint past Level 2 — violates AGENTS.md policy.
