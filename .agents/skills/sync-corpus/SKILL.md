---
name: "sync-corpus"
description: "Run the full corpus sync pipeline in safe sequence: validate schemas, check vault drift, diff records to corpus export, rebuild companion data, refresh dashboards, and report endurecimento status."
---
