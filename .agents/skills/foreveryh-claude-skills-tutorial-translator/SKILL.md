---
name: translator
description: Professional translation using Codex's native capabilities. Use this skill when the user needs to translate text between languages with high quality, or when content needs to be localized for different language audiences.
version: 1.0.0
---

# Professional Translation Skill

Provide professional, high-quality translation using Codex's native language understanding and generation capabilities.
...
- This skill uses Codex's native multilingual capabilities, no external translation APIs required
