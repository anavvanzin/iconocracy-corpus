---
id: SCOUT-SESSION-2026-03-31c
tipo: sessao-scout
data: "2026-03-31"
sessao: "2026-03-31c"
total_candidatos: 4
total_zwischenraum: 1
total_controles_negativos: 0
lacunas_atacadas: ["UK moedas George V", "BR moedas 1906-1913", "DE Weimar selos Germania", "FR Semeuse camée"]
paises: [UK, BR, DE, FR]
periodo: "1906-1925"
tags:
  - corpus/sessao-scout
...
# SCOUT Session — 2026-03-31c

## Sumário executivo

Sessão de preenchimento de lacunas críticas documentadas em SCOUT-SESSION-2026-03-31b. Quatro candidatos de **confiança ALTA ou MÉDIA**, um painel Zwischenraum de alta densidade argumentativa. Nenhum item de confiança baixa incluído.
...
## Painel Zwischenraum adicionado

| ID | Título | Polos | Argumento central |
|---|---|---|---|
| SCOUT-ZW-13 | Germania selo × Águia moeda — Weimar (1920–1925) | SCOUT-122 × SCOUT-NC-03 | O suporte material — não o regime político — decide o ritmo do abandono iconocrático |

---

## Estado do corpus após esta sessão

| Métrica | Antes (31b) | Depois (31c) | Δ |
|---|---|---|---|
| Candidatos vault | ~119 | 123 | +4 |
| Zwischenraum panels | 12 | 13 | +1 |
| IDs UK moedas (período George V) | 0 | 1 | +1 |
| IDs BR moedas 1900-1920 | 1 | 2 | +1 |
| IDs DE selos período Weimar | 0 | 1 | +1 |
| IDs FR Semeuse camée | 0 | 1 | +1 |
...
| Lacuna (31b) | Status 31c |
|---|---|
| UK moedas — Britannia (penny, crown, 1880-1920) | ✅ SCOUT-120 (1912 George V) — lacuna cronológica principal fechada |
| BR moedas — Efígie da República (1889-1920) | ✅ SCOUT-121 (2000 Réis 1906) — série iniciada; falta 1000 Réis |
| DE Weimar selos — Germania pós-1919 | ✅ SCOUT-122 (Mi.141 1920) — lacuna crítica preenchida |
| FR Semeuse selos — camée vs. lignée | ✅ SCOUT-123 (camée 10c 1906) — variante camée adicionada |

---

## Lacunas que persistem

1. **UK florin/crown George V (1910-1920)** — SCOUT-120 cobre o penny. Os denominações maiores (florin, half-crown, crown) com Britannia em postura diferente ainda faltam.
2. **BR 1000 Réis (série intermediária)** — SCOUT-121 cobre 2000 Réis. A série 1000 Réis (denominação mais circulada) ainda falta.
3. **DE Weimar selos pós-1922** — Mi.141 foi a última emissão Germania (1920-1921). O que o substituiu nos selos? Investigar emissões 1922-1933.
4. **FR Semeuse camée "sem sol"** — SCOUT-123 usa imagem da variante "com sol" (1ª emissão, abr. 1906). A variante canônica é "sem sol" (jul. 1906, 55M ex.) — obter imagem.
5. **FR Semeuse e outras denominações** — Corpus tem 15c (lignée), 10c camée. Faltam 5c, 25c, 50c.
6. **ZW panel — Britannia série longitudinal George V** — expandir SCOUT-ZW-08 com SCOUT-120.

---

## Próximas sessões sugeridas

### Prioridade 1 — Fechar série UK moeda longitudinal
Buscar: **George V florin/half-crown 1911-1920** com Britannia — Numista + Museums Victoria. Completar ZW-08 com dado de 1912.

### Prioridade 2 — Semeuse canônica (sem sol) + 25c
Buscar imagem da **Semeuse camée 10c sans sol** (julho 1906) via Gallica IIIF ou BnF. Adicionar **25c Semeuse camée** (a mais emitida, usada na tarifa postal básica). Propor ZW panel Semeuse lignée × Semeuse camée.

### Prioridade 3 — Selos Weimar pós-1922
...
## Nota metodológica — argumento emergente da sessão 31c

A comparação transversal dos 4 candidatos desta sessão sugere uma **tipologia de persistência iconocrática**:

| País | Figura | Persistência | Mecanismo de ruptura |
|---|---|---|---|
| FR | Semeuse (MÉDIO) | 1898-1941 | Nenhuma — design Roty é "resistente" |
| UK | Britannia (ALTO) | 1695-? | Inercial — 270+ anos sem ruptura |
| DE | Germania (ALTO) | 1900-1922 | Hiperinflação econômica — colapso externo |
| BR | República (MÉDIO) | 1889-1985+ | Persistência com estabilização precoce |

Esta tipologia pode estruturar a seção comparativa do Cap. 5.
