---
id: DIR410346-Aula-Iconocracia-2026
tipo: aula
status: planejamento
tags:
  - dir410346
...
# Trilogia Iconocracia — DIR410346 (Abril 2026)
...
- **Cartão-resposta**: “Descreva em 3 linhas como a imagem selecionada legitima exclusão feminina” + “Identifique um indicador IconoCode visível”.
- **Materiais**: slides (Mapa temporal), caderno de atividades, QR code para dashboard.
- **Referências para leitura prévia**: Pateman (1988), Goodrich (2017), Huygebaert (2018).
...
- Playlist curta com variações de Debussy e Villa-Lobos para marcar cada regime iconocrático.
- Cartas “indicador IconoCode” para gamificar observação (distribuir antes da oficina).
- Formulário de feedback rápido (QR code) para ajustar próximas sessões.
