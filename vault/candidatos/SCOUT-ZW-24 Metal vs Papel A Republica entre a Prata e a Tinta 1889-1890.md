...
status: ativo
titulo: "Painel 24 -- METAL CONTRA PAPEL: O Duplo Nascimento da República entre a Prata e a Tinta (BR, 1889–1890)"
pais: [BR, BR]
periodo: "1889-1890"
tags:
  - corpus/zwischenraum
  - painel/endurecimento-transmidiatico
  - painel/numismatica-brasileira
  - metodo/warburg
  - pais/BR
  - suporte/moeda
  - suporte/cedula
...
**Polo B (Brasil, 1890):** *50 Mil Réis — Cédula do Banco do Brazil* (SCOUT-423) — Primeira emissão em papel-moeda de altíssima denominação. Waterlow & Sons, Londres. Três alegorias femininas: Liberdade (busto central), Governo (sentada à esquerda), Justiça (sentada à direita). Corpo expandido, policromia, guilloché.

### Dados Comparados

| Elemento | Polo A — Moeda (1889) | Polo B — Cédula (1890) |
|----------|------------------------|------------------------|
| **Item** | 1000 Réis (KM# 495) | 50 Mil Réis |
| **SCOUT** | SCOUT-422 | SCOUT-423 |
| **Data** | 1889 | 1890 |
| **Suporte** | Moeda (prata .917) | Cédula (papel-moeda) |
| **Materialidade** | 12,75 g, 30 mm, metal nobre | Papel gravado, grande formato |
| **Impressora/Casa** | Casa da Moeda do Brasil | Waterlow & Sons, Londres |
| **Denominação** | 1.000 réis | 50.000 réis |
| **Regime** | FUNDACIONAL | FUNDACIONAL |
| **N° de alegorias** | 1 (Efígie da República) | 3 (Liberdade, Governo, Justiça) |
| **Postura** | Busto em perfil | Busto (centro) + sentadas (laterais) |
| **Atributos** | "ORDEM E PROGRESSO", estrelas | Balança, espada, toga, guilloché |
...
|-----------|----------------|-----------------|------------|
| desincorporação | **alta** (busto apenas) | **baixa** (3 corpos presentes) | Inversão máxima: o metal elimina o corpo; o papel o preserva |
| rigidez_postural | **alta** (perfil fixo) | **moderada** (sentadas, mas compostas) | O metal impõe rigidez; o papel permite pose |
| dessexualização | **alta** (sem corpo) | **moderada** (toga clássica, sem nudez) | Ambos dessexualizam, mas por vias distintas |
| uniformização_facial | **moderada** (efígie inaugural) | **moderada** (rostos idealizados) | Ponto de convergência entre os suportes |
| heraldicização | **moderada** (estrelas, "ORDEM E PROGRESSO") | **baixa** (figuras não integradas em brasão) | O metal tende ao heráldico; o papel tende ao narrativo |
| enquadramento_arquitetônico | **moderado** (moldura circular) | **alto** (guilloché, molduras ornamentais) | Único indicador em que a cédula supera a moeda |
| apagamento_narrativo | **alto** (ícone puro, sem cena) | **moderado** (cena alegórica tripartida) | O metal apaga a narrativa; o papel a retém |
| monocromatização | **máxima** (prata monocromática) | **alta** (tons limitados, mas não monocromática) | A matéria-prima do metal já é monocromática por natureza |
...
O *Zwischenraum* entre os polos revela duas modalidades radicalmente distintas do Contrato Sexual Visual operando no mesmo momento fundacional:

**Polo A — O Contrato por Condensação:** A moeda de prata reduz a República a um rosto. O corpo feminino inteiro é sacrificado à lógica circular do metal: o que resta é uma cabeça feminina que funciona como selo — marca de autenticidade, não sujeito. O Contrato Sexual Visual opera aqui por *condensação máxima*: toda a carga simbólica da República — liberdade, justiça, governo, ordem, progresso — é comprimida num único perfil feminino. A mulher não representa uma virtude específica; ela *é* o Estado inteiro, e precisamente por isso não pode ter corpo. O corpo seria excesso, ruído, particularidade intolerável no campo comprimido da moeda. A Feminilidade de Estado atinge aqui sua forma mais pura: o feminino como função estatal sem resíduo corporal.
