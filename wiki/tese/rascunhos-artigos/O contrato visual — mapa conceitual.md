...
```
   ...
   (Mondzain 2002)         (Indicadores IconoCode)
    ...
    +-------+------+     +---------+---------+
    |              |     |                   |
[Feminilidade   [Acoplamento   [Fundacional vs Militar]
 de Estado]      imagem-norma] (dados Cap.6)
    |              |     |                   |
 (Legendre)    (Field 11) [Tabela Kruskal] [Casos qualitativos]
...
- LEGENDRE, Pierre. *Leçons VII*. 2004.
- GOODRICH, Peter. *Imago Decidendi*. 2017.
- WARBURG, Aby. *Der Bilderatlas Mnemosyne*. 2020 ed.
