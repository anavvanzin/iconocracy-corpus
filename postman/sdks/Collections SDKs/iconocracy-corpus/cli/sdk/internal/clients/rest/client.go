...
import (
	...
	"example.com/iconocracy-corpus-sdk/sdk/internal/clients/rest/handlers"
...
func NewRestClient[T any, E any](config iconocracycorpussdkconfig.Config, hook hooks.Hook) *RestClient[T, E] {
