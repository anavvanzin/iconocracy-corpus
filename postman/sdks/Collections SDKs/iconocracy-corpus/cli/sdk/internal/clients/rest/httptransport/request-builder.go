...
func NewRequestBuilder() *RequestBuilder {
	...
	rb.request.SetHeader("User-Agent", "postman-codegen/2.25.51 iconocracycorpussdk/1.0.0 (go)")
	return rb
}
...
// Returns the builder for method chaining.
func (rb *RequestBuilder) WithConfig(config iconocracycorpussdkconfig.Config) *RequestBuilder {
