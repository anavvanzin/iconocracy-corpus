package com.iconocracycorpussdk.config;
...
@Builder
@Data
public class IconocracyCorpusSdkConfig {

  @NonNull
  @Builder.Default
  private String userAgent = "postman-codegen/2.25.51 iconocracycorpussdk/1.0.0 (java)";
