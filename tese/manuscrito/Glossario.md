---
title: "Glossário"
subtitle: "ICONOCRACIA: Alegoria Feminina na História da Cultura Jurídica (Séculos XIX–XX)"
author: "Ana Vanzin"
lang: pt-BR
type: glossario
status: rascunho
created: 2026-06-26
updated: 2026-06-26
tags: [glossario, tese, conceitos, terminologia, warburg, iconologia, cultura-juridica]
abnt: "NBR 6023:2025"
---
...
```mermaid
flowchart TD
    PC["🔹 Purificação Clássica<br/><i>operação formal</i>"]
    END["⚙️ Endurecimento<br/>10 indicadores (0–3)"]
    CSV["🔹 Contrato Sexual Visual"]
    FE["🔹 Feminilidade de Estado"]
    CRV["🔹 Contrato Racial Visual"]
    AIN["🔹 Acoplamento imagem-norma"]

    PC -->|operacionaliza-se em| END
    PC --> CSV
    PC --> FE
    PC --> CRV
    CSV --- AIN
    ...
    subgraph RAIZ["Matriz convocada (interlocutores)"]
        K["👤 Kantorowicz<br/>dois corpos do rei"]
        L["👤 Legendre<br/>juiz totêmico"]
        H["👤 Hespanha<br/>cultura jurídica"]
        LAT["👤 Latour 1991<br/>purificação/tradução"]
        HAR["👤 Haraway 1985"]
        DES["👤 Descola"]
    end
    K -.matriz jurídica.-> PC
    L -.matriz jurídica.-> PC
    H -.matriz jurídica.-> PC
    LAT -.extensão ferramental.-> PC
    HAR -.extensão ferramental.-> PC
    DES -.extensão ferramental.-> PC
```
...
```mermaid
flowchart LR
    F["FUNDACIONAL<br/>sacrificial · corpo vivo"] --> N["NORMATIVO<br/>domesticado · burocrático"] --> M["MILITAR<br/>endurecido · imperial"]
    M -.subversão.-> C["CONTRA-ALEGORIA<br/>contestada"]
    style F fill:#f9e0e0,stroke:#b5651d
    style N fill:#f5f0d0,stroke:#9a8a2a
    style M fill:#d8d8e8,stroke:#444466
    style C fill:#d8ecd8,stroke:#2a7a2a
```
