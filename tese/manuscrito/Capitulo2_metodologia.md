...
> — Aby Warburg, sobre o Atlas Mnemosyne (reconstrução de Didi-Huberman, 2002)

> *"L'économie de l'icône est une économie du regard et du pouvoir."*
> — Marie-José Mondzain, *Image, icône, économie* (2002, p. 28)
...
O corpus é tratado, nesta tese, como um objeto versionado. O ledger e o export registram a história de catalogação, enquanto a análise quantitativa se restringe ao estrato analítico composto por registros com codificação de purificação e proveniência de instrumento auditável. Itens sem codificação válida não ingressam nas estatísticas de endurecimento; a definição final do N analítico depende da auditoria de confiabilidade entre instrumentos e fica declarada no dataset card metodológico.
...
*O Capítulo 3 apresentará os resultados da análise quantitativa.*
