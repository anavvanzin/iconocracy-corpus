...
iconocráticos: da alegoria fundacional que ainda respira (Marianne na barricada) ao teto normativo
de pedra (o Palais de Justice de Bruxelas), do endurecimento militar (a Piastre, a Justiça de
...
> selo definitivo (1903) e à Marianne assentada da Piastre colonial (1885) — é a demonstração
> longitudinal mais nítida da Purificação Clássica: um mesmo motivo nacional percorre, em oito
> décadas, todo o gradiente de endurecimento, e o faz na razão inversa de sua carga narrativa. Quanto
...
sem codificação quantitativa — e por isso não entra como escore —, mas entra como o que a tipologia
...
> quando marcial (a estampa popular). O grau de purificação mede a distância entre a mulher simbólica e
> a mulher real: quanto mais alto o escore, mais completa a substituição.

A *Justice* vendada, de espada e balança (corpus item `734dd76f`, composto 2,2), é descrita na
...
`416a2c38`, composto 2,1), com enquadramento arquitetônico no valor máximo (3). O indicador não é
...
Columbia oferece o gradiente marcial. Da cromolitografia em que ela entrega a espada ao almirante
Dewey (1899; corpus item `610a396d`, composto 1,0) ao cartaz de recrutamento *Columbia calls — Enlist
now* (1917; corpus item `473ac4d7`, composto 1,6), o motivo percorre o regime **militar**: o corpo
...
codificada do item remete a Carvalho [@carvalho1990], e a comparação sugerida pela própria nota — com
uma República anterior de escore muito inferior — desenha um *arco de endurecimento de cinquenta anos*
em que cada indicador sobe.

A "República sobre coluna" materializa-se no Monumento à República de Belém (1940; corpus items
`ae8876ff`, composto 2,1, e o detalhe `d5c61575`, composto 1,7): figura feminina no alto de uma
coluna, elevada acima do espaço cívico. O par de registros é metodologicamente precioso porque isola
a **mediação do suporte**: a diferença de escore entre a vista geral e o detalhe (delta 0,4) prova que
o enquadramento — fotográfico ou monumental — é ele próprio um operador de endurecimento. Não é só a
...
vandalizada durante os atos de 8 de janeiro de 2023 (corpus item `e0399402`, sem codificação
quantitativa), entra como **contra-alegoria** involuntária: o gesto iconoclasta que, ao atacar a
...
a face de bronze. A iconoclastia é, aqui, a prova negativa da tese.

## 7.5 — O Palais de Justice de Bruxelas

> **Tese parcial.** O Palais de Justice de Poelaert é o teto empírico do corpus: o único item cujo
> vetor tende ao máximo em todos os dez indicadores. Ele demonstra a forma-limite da Feminilidade de
...
O Palais de Justice de Bruxelas (Joseph Poelaert, 1866–1883; corpus item `d77a533b`) é registrado no
...
*Die Wage der Macht / La balance de la puissance* (1780; corpus item `1ae7c4ae`, composto 1,0) e
*America pois'd in the balance of justice* (1776; corpus item `543550b1`, composto 0,6) são estampas
...
O dado quantitativo fecha o argumento do capítulo. Ambos os itens têm escore baixo (1,0 e 0,6) e
apagamento narrativo mínimo — são imagens *que contam uma história*. A nota de codificação de
`543550b1` cristaliza a regularidade que atravessa 7.1, 7.3 e 7.6: *máximo de narrativa = mínimo de
endurecimento*. É a lei empírica que a análise qualitativa oferece à quantitativa: a Purificação
Clássica opera subtraindo narrativa. Endurecer é fazer calar. A alegoria plenamente purificada — a
