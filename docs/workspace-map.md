...
| `iconocracy-ingest` | `/Users/ana/Research/pipelines/iconocracy-ingest` | Pipeline de ingestao que alimenta os dados do hub | derived | symlink em `iconocracy-ingest/` dentro do hub |
...
| `iconocracy-vault` | `/Users/ana/Research/vaults/iconocracy-vault` | Vault canonico da tese; `vault/` no hub e apenas espelho | canonical | symlink em `vault/` dentro do hub |
| `dir410346-vault` | `/Users/ana/Research/vaults/dir410346-vault` | Vault de disciplina, separado do vault da tese | experimental | symlink em `vault/obsidian-dir410346` |
| `dir410340-vault` | `/Users/ana/Research/vaults/dir410340-vault` | Vault de disciplina, separado do vault da tese | experimental | symlink em `vault/obsidian-dir410340` |
